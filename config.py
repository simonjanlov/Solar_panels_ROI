...
tilt_and_direction_table_csvpath = r'data\tilt_and_direction_table.csv' # find_tilt_and_direction_value.py
predicted_prices_withzones_csvpath = r'data\predicted_prices_withzones.csv' # data_dicts.py
